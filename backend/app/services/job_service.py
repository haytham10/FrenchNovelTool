...
class JobService:
    ...
    @staticmethod
    def create_job(user_id: int, original_filename: str, model_preference: str,
                  estimated_tokens: int, processing_settings: Dict[str, Any]) -> Job:
        """
    ...
    @staticmethod
    def get_user_jobs(user_id: int, limit: Optional[int] = None, 
