...
class UserSettingsService:
    ...
    def save_user_settings(self, user_id, settings_dict):
        ...
        if settings:
            ...
            settings.sentence_length_limit = settings_dict.get(
            ...
            settings.ignore_dialogue = settings_dict.get(
                "ignore_dialogue", settings.ignore_dialogue
            )
            settings.preserve_formatting = settings_dict.get(
                "preserve_formatting", settings.preserve_formatting
            )
            settings.fix_hyphenation = settings_dict.get(
                "fix_hyphenation", settings.fix_hyphenation
            )
            settings.min_sentence_length = settings_dict.get(
