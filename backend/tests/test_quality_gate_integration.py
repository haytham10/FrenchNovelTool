...
class TestQualityGateIntegration:
    ...
    def test_quality_gate_rejects_fragments(self, gemini_service_with_quality_gate):
        ...
        mock_sentences = [
            ...
            "Pour toujours et � jamais.",  # Fragment (no verb)
            "Il faisait tr�s froid.",  # Valid
        ]
        ...
        assert "Elle est tr�s belle." in result
        assert "Il faisait tr�s froid." in result

        # Verify: Fragments should be rejected
        assert "Dans la rue sombre." not in result
        assert "Pour toujours et � jamais." not in result
    ...
    def test_quality_gate_with_edge_cases(self, gemini_service_with_quality_gate):
        ...
        mock_sentences = [
            "O� vas-tu maintenant ?",  # Valid question
            "Il faisait tr�s froid.",  # Valid statement
        ...
        assert "O� vas-tu maintenant ?" in result or "O� vas-tu maintenant?" in result
        assert "Il faisait tr�s froid." in result
    ...
    def test_quality_gate_respects_sentence_length_limits(self, gemini_service_with_quality_gate):
        ...
        mock_sentences = [
            ...
            "Il mange des pommes rouges et d�licieuses maintenant.",  # Too long (9 words, max 8)
        ]
...
class TestEndToEndScenarios:
    ...
    def test_realistic_mixed_output(self, gemini_service_with_quality_gate):
        ...
        mock_gemini_output = [
            ...
            "La rue �tait sombre et froide.",  # Valid (6 words)
            "dans la rue sombre",  # Fragment (no capital, no punct, no verb)
            "Il pensait � elle constamment.",  # Valid
            "Pour toujours et � jamais.",  # Fragment (no verb)
            "Elle �tait partie depuis longtemps.",  # Valid (6 words)
        ]
    ...
    def test_all_fragments_rejected(self, gemini_service_with_quality_gate):
        ...
        all_fragments = [
            ...
            "Pour toujours et � jamais.",  # No verb
