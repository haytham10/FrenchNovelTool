...
class TestHistoryChunkIntegration:
    ...
    def mock_chunks_success(self):
        ...
        for i in range(3):
            ...
            chunk.result_json = {
                "sentences": [
                    {"normalized": f"New sentence {i+1}", "original": f"Original sentence {i+1}"}
                ]
            }
    ...
    def test_rebuild_sentences_from_chunks_all_success(
        self, history_service, mock_history_entry, mock_chunks_success
    ):
    ...
    def test_rebuild_sentences_from_chunks_mixed_status(
        self, history_service, mock_history_entry, mock_chunks_mixed
    ):
    ...
    def test_get_entry_with_details_uses_live_chunks(
        self, history_service, mock_history_entry, mock_chunks_success
    ):
    ...
    def test_get_entry_with_details_uses_snapshot(
        self, history_service, mock_history_entry, mock_chunks_success
    ):
    ...
    def test_refresh_from_chunks(
        self, history_service, mock_history_entry, mock_chunks_success, mock_db
    ):
